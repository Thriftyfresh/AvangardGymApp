  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Women's Dashboard", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
        ...
        builder: (context, state) {
          ...
          return RefreshIndicator(
            ...
            child: CustomScrollView(
              ...
              slivers: [
                SliverToBoxAdapter(child: _buildHeader(context, loaded)),
                SliverPadding(
                  padding: const EdgeInsets.fromLTRB(16, 0, 16, 16),
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      if (state is MemberLoading)
                        const Padding(padding: EdgeInsets.only(top: 40), child: Center(child: CircularProgressIndicator(color: Colors.pink)))
                      else
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Members', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
      ),
    );
  }

  Widget _buildHeader(BuildContext context, MemberLoaded? loaded) {
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xFF3D0028), Color(0xFF7B0045), Color(0xFF3D0028)],
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text("Women's Section", style: TextStyle(color: Colors.white.withOpacity(0.75), fontSize: 13)),
                ],
              ),
            ],
          ),
          ...
          Row(
            children: [
              Expanded(child: _headerStat('Total', loaded?.total ?? 0, Icons.people_rounded, Colors.pink)),
              _vertDivider(),
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Row(children: [
              Container(width: 4, height: 20, decoration: BoxDecoration(color: Colors.pink, borderRadius: BorderRadius.circular(2))),
        ...
        if (loaded == null || loaded.expiringSoon.isEmpty)
          ...
          ...loaded.expiringSoon.map((member) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: isUrgent ? Colors.red.withOpacity(0.06) : Colors.pink.withOpacity(0.06),
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: isUrgent ? Colors.red.withOpacity(0.15) : Colors.pink.withOpacity(0.15)),
              ),
              child: ListTile(
                ...
                trailing: Container(
                  ...
                  decoration: BoxDecoration(
                    color: isUrgent ? Colors.red : Colors.pink,
                    borderRadius: BorderRadius.circular(20),
                  ),
                  child: Text('$daysLeft day${daysLeft == 1 ? '' : 's'}',
      ...
      child: Column(
        children: [
          Container(
            ...
            decoration: const BoxDecoration(
              gradient: LinearGradient(
                colors: [Color(0xFF3D0028), Color(0xFF7B0045)],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
            ),
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                _drawerItem(context, Icons.dashboard_rounded, 'Dashboard', Colors.pink, () => Navigator.pop(context)),
                _drawerItem(context, Icons.people_rounded, 'Members', Colors.pink, () {
                ...
                _drawerItem(context, Icons.bar_chart_rounded, 'Charts & Stats', Colors.purple,
                    isSuperAdmin ? () { Navigator.pop(context); Navigator.push(context, MaterialPageRoute(builder: (_) => const WomenChartsScreen())); } : null,
                ...
                Padding(
                  ...
                  child: Row(children: [
                    Container(width: 3, height: 14, decoration: BoxDecoration(color: Colors.deepOrange, borderRadius: BorderRadius.circular(2))),
                    const SizedBox(width: 8),
                    Text("MEN'S SECTION", style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.deepOrange[400], letterSpacing: 1)),
                  ]),
                ),
                _drawerItem(context, Icons.man_rounded, "Men's Dashboard", Colors.deepOrange, () {
                  Navigator.pop(context);
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    trailing: Switch(value: isDark, activeColor: Colors.pink, onChanged: (_) => MyApp.of(context)?.toggleTheme()),
